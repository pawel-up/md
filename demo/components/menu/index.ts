...
import type { UiMenuItemElement } from '../../../src/components/menu/ui-menu-item.js'
  ...
  contentTemplate(): TemplateResult {
    ...
    return html`
      ...
      <section class="demo-section">
        ...
        <ui-menu id="single-select-menu" popover="auto" selectOnActivate @select="${this.handleIconSelectMenuSelect}">
      ...
      <section class="demo-section">
        ...
        <ui-menu id="auto-check-menu" selectOnActivate popover="auto" @select="${this.handleAutoCheckMenuSelect}">
      ...
      <section class="demo-section">
        ...
        <div style="display: flex; justify-content: space-between; margin: 20px 0;">
          <ui-button id="left-edge-menu-trigger" color="filled" popovertarget="left-edge-menu"
            >Left Edge Complex</ui-button
          >
          <ui-button id="right-edge-menu-trigger" color="filled" popovertarget="right-edge-menu"
            >Right Edge Complex</ui-button
          >
        </div>
