...
class ComponentDemoPage extends DemoPage {
  ...
  @reactive() accessor keyboardTestSelected: string | undefined

  @reactive() accessor typeAheadSelected: string | undefined
  ...
  contentTemplate(): TemplateResult {
    return html`
      ...
      <section>
        ...
        <ui-select id="no-icon-select" @change="${this.handleNoIconSelectChange}" style="width: 100%;">
      ...
      <section>
        ...
        <ui-select id="typeahead-test-select" @change="${this.handleTypeAheadSelectChange}" label="Type to search">
      ...
      <section>
        ...
        <ui-select id="keyboard-test-select" @change="${this.handleKeyboardTestSelectChange}" label="Test Navigation">
  ...
  handleKeyboardTestSelectChange(e: CustomEvent): void {
    const { value } = e.detail
    this.keyboardTestSelected = value
  ...
  handleTypeAheadSelectChange(e: CustomEvent): void {
    const { value } = e.detail
    this.typeAheadSelected = value
